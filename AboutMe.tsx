            ...
            <div className="space-y-12 md:space-y-16">
              ...
              <div className="royal-card p-8 md:p-16 rounded-[2.5rem] border border-white/5 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-8 text-brand-medium text-base md:text-lg leading-[1.8] font-medium">
                  ...
                  <p>
                    My academic strategy is built on a dual-track approach: I am currently <a href="/academics#associates-plan" className="text-amber-400 font-bold hover:underline">on track to complete my Associate's Degree</a> while still in high school. This involves a rigorous selection of <a href="/academics#acc-coursework" className="text-amber-400 font-bold hover:underline">Computer Science and related coursework at Austin Community College (ACC)</a>, complemented by advanced AP classes at my home campus. My academic excellence is further recognized through my induction into the <a href="/academics#nsls" className="text-amber-400 font-bold hover:underline">National Society of Leadership and Success (NSLS)</a> and the <a href="/academics#njhs" className="text-amber-400 font-bold hover:underline">National Junior Honor Society (NJHS)</a>, alongside my recognition by the College Board with the <span className="text-amber-400 font-bold">Small Town and Rural Awards</span>.
                  </p>

                  <p>
                    In the technical realm, I treat cybersecurity research as a craft. I have achieved <span className="text-amber-400 font-bold">official C++ and Python certifications</span> from recognized institutions, alongside specialized training as a <span className="text-amber-400 font-bold">Network Security Specialist</span>. This technical foundation led to the development of <a href="/skills#defensive-grid-labs" className="text-amber-400 font-bold hover:underline">Defensive Grid Labs</a>, an elite cybersecurity initiative focused on Digital Sovereignty and Zero-Knowledge Architecture, as well as professional certifications in web development from the <a href="/skills#html-5" className="text-amber-400 font-bold hover:underline">University of Michigan</a>.
                  </p>

                  <p>
                    My competitive drive is best reflected in my leadership within the UIL circuit and business organizations. As the <a href="/skills#uil-legacy" className="text-amber-400 font-bold hover:underline">Captain of the UIL Website Team</a>, I led my group to a <a href="/skills#uil-legacy" className="text-amber-400 font-bold hover:underline">District Championship (1st Place)</a> and a <a href="/skills#uil-legacy" className="text-amber-400 font-bold hover:underline">3rd Place finish at the State level</a> during the 2024-2025 season. I am also a <span className="text-amber-400 font-bold">2-year member of the UIL Mathematics and CX Debate teams</span>, contributing to back-to-back <a href="/skills#uil-mathematics-team" className="text-amber-400 font-bold hover:underline">2nd Place District finishes for the Mathematics Team (2025-2026)</a> and securing <a href="/skills#uil-cx-debate" className="text-amber-400 font-bold hover:underline">6th Place in District for CX Debate</a>. I am also an active member of <a href="/skills#deca-business-operations" className="text-amber-400 font-bold hover:underline">DECA</a> and have served in <a href="/skills#rotary-club" className="text-amber-400 font-bold hover:underline">Rotary for two years</a>. My team-based competitive record also includes Robotics (3rd in District 2024, 2nd in District 2025).
                  </p>

                  <p>
                    Leadership and community impact are the pillars of my personal philosophy. Whether serving as the <a href="/skills#njhs-treasurer" className="text-amber-400 font-bold hover:underline">NJHS Treasurer</a>, managing high-volume <a href="/skills#summer-business-operations" className="text-amber-400 font-bold hover:underline">Summer Business Operations</a> reporting directly to executive leadership, or leading global data science initiatives through <a href="/skills#code-4-change" className="text-amber-400 font-bold hover:underline">Code 4 Change</a>, I strive to bridge the gap between technical mastery and social responsibility. This discipline extends to my personal life, where I am a <a href="/skills#karate-excellence" className="text-amber-400 font-bold hover:underline">3rd Gup Karate student</a> nearing my Black Belt and an instructor of <a href="/skills#telugu-teaching" className="text-amber-400 font-bold hover:underline">Telugu teaching</a>.
                  </p>
